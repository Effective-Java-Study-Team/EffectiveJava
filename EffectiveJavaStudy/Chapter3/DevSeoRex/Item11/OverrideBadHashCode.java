public class OverrideBadHashCode {
    ...
    public static void main(String[] args) {
        BadHashCode badHashCode1 = new BadHashCode(100, 100); //45
        BadHashCode badHashCode2 = new BadHashCode(100, 100); //45
        BadHashCode badHashCode3 = new BadHashCode(100, 50); //45
